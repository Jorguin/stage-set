...
- Name: app.spec.ts >> App loads >> should show auth page when not logged in
...
Locator: locator('text=Entrar con Magic Link')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Entrar con Magic Link')
